<%@ page import='java.util.*,com.doublechaintech.inventory.*,com.doublechaintech.inventory.formmessage.FormMessage'%>
...
<sky:include page="com/doublechaintech/inventory/formmessage/FormMessage$Summary.jsp" />
