<%@ page import='java.util.*,com.doublechaintech.inventory.*,com.doublechaintech.inventory.secuserblocking.SecUserBlocking'%>
...
<sky:include page="com/doublechaintech/inventory/secuserblocking/SecUserBlocking$Summary.jsp" />
