<%@ page import='java.util.*,com.doublechaintech.inventory.*,com.doublechaintech.inventory.objectaccess.ObjectAccess'%>
...
<sky:include page="com/doublechaintech/inventory/objectaccess/ObjectAccess$Summary.jsp" />
...
<sky:include page="com/doublechaintech/inventory/userapp/UserApp$Info.jsp" />
