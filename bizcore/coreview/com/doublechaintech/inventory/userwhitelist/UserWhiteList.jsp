<%@ page import='java.util.*,com.doublechaintech.inventory.*,com.doublechaintech.inventory.userwhitelist.UserWhiteList'%>
...
<sky:include page="com/doublechaintech/inventory/userwhitelist/UserWhiteList$Summary.jsp" />
