<%@ page import='java.util.*,com.doublechaintech.inventory.*,com.doublechaintech.inventory.platform.Platform'%>
...
<div class="row">
	...
	<% Platform result = (Platform)request.getAttribute("result");  %>
			...
			<li><a data-toggle="tab" href="#skuInventoryList" class="disabled"> ${userContext.localeMap['sku_inventory']}</a></li>
...
<sky:include page="com/doublechaintech/inventory/platform/Platform$Summary.jsp" />
		...
		<div id="productList" class="tab-pane fade sublist" refer-name="platform">
			<sky:include page="com/doublechaintech/inventory/product/Product$List.jsp"
					referName="platform"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["skuInventoryList"] or ignoreListAccessControl}'>
		<c:set var="skuInventoryList" value="${result.skuInventoryList}" scope="request"/>
		<c:set var="skuInventoryListName" value="skuInventoryList" scope="request"/>
		<div id="skuInventoryList" class="tab-pane fade sublist" refer-name="platform">
			<sky:include page="com/doublechaintech/inventory/skuinventory/SkuInventory$List.jsp"
					referName="platform"/>
		</div>
	</c:if>
