<%@ page import='java.util.*,com.doublechaintech.inventory.*,com.doublechaintech.inventory.formaction.FormAction'%>
...
<sky:include page="com/doublechaintech/inventory/formaction/FormAction$Summary.jsp" />
