<%@ page import='java.util.*,com.doublechaintech.inventory.*,com.doublechaintech.inventory.skuinventory.SkuInventory'%>
...
<c:set var="ownerBeanName" value="skuInventory" scope="request"/>
<c:set var="ownerClassName" value="SkuInventory" scope="request"/>
...
<div class="row">
	...
	<% SkuInventory result = (SkuInventory)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="skuInventory" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/inventory/skuinventory/SkuInventory$Summary.jsp" />
...
<sky:include page="com/doublechaintech/inventory/product/Product$Info.jsp" />
