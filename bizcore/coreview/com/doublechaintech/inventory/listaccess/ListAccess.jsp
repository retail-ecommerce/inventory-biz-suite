<%@ page import='java.util.*,com.doublechaintech.inventory.*,com.doublechaintech.inventory.listaccess.ListAccess'%>
...
<sky:include page="com/doublechaintech/inventory/listaccess/ListAccess$Summary.jsp" />
