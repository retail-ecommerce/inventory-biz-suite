<%@ page import='java.util.*,com.doublechaintech.inventory.*,com.doublechaintech.inventory.formfield.FormField'%>
...
<sky:include page="com/doublechaintech/inventory/formfield/FormField$Summary.jsp" />
