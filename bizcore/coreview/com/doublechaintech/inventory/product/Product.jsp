<%@ page import='java.util.*,com.doublechaintech.inventory.*,com.doublechaintech.inventory.product.Product'%>
...
<sky:include page="com/doublechaintech/inventory/product/Product$Summary.jsp" />
...
<sky:include page="com/doublechaintech/inventory/platform/Platform$Info.jsp" />
		...
		<div id="skuInventoryList" class="tab-pane fade sublist" refer-name="product">
