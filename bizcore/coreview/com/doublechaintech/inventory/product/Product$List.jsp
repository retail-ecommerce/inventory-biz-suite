...
<c:if test="${param.referName ne 'introduction'}">
	<th>${userContext.localeMap['product.introduction']}</th>
</c:if>
...
</c:if><c:if test="${param.referName ne 'introduction'}">	<td contenteditable='true' class='edit-value'  propertyToChange='introduction' storedCellValue='${item.introduction}' prefix='${ownerBeanName}Manager/updateProduct/${result.id}/${item.id}/'>${item.introduction}</td>
...
<c:if test="${param.referName ne 'lastUpdateTime'}">	<td contenteditable='true' class='edit-value'  propertyToChange='lastUpdateTime' storedCellValue='${item.lastUpdateTime}' prefix='${ownerBeanName}Manager/updateProduct/${result.id}/${item.id}/'><fmt:formatDate pattern="yyyy-MM-dd'T'HH:mm:ss" value="${item.lastUpdateTime}" /></td>
</c:if>
				<td>
