<%@ page import='java.util.*,com.doublechaintech.inventory.*,com.doublechaintech.inventory.loginhistory.LoginHistory'%>
...
<sky:include page="com/doublechaintech/inventory/loginhistory/LoginHistory$Summary.jsp" />
