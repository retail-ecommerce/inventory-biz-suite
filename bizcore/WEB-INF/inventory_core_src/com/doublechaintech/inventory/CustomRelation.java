...
public class CustomRelation extends BaseRelation{
	...
	protected void prepareRelation()
	{
		...
		//replaceGenericRelation("SkuInventory"                          , BaseRelation.TRUST_CHAIN_ALL, "product");
		//replaceGenericRelation("SkuInventory"                          , BaseRelation.TRUST_CHAIN_ALL, "platform");
	...
	protected void prepareRelationIndex()
	{
		...
		*/
		...
		//String [] skuInventoryRelatedObjectNames = {"product:Product","platform:Platform"};
		//replaceRelationIndex("SkuInventory",skuInventoryRelatedObjectNames);
