...
import com.doublechaintech.inventory.secuser.SecUserCustomManagerImpl;
import com.doublechaintech.inventory.userapp.UserApp;
import com.doublechaintech.inventory.userapp.UserAppTokens;
import com.terapico.utils.CollectionUtils;

public class InventoryUserContextImpl extends UserContextImpl implements InventoryUserContext{
	...
	static final String RESOURCE_PATH="com.doublechaintech.inventory.InventoryResources";
	static final String CUSTOM_RESOURCE_PATH="com.doublechaintech.inventory.InventoryCustomResources";
    ...
    /*
    public static SecUser getSecUser(InventoryUserContext userContext) {
	...
	public static UserApp getSingleUserAppByObjectName(InventoryUserContext userContext, String objectName)
			throws Exception {
		SecUserCustomManagerImpl secUserManager = (SecUserCustomManagerImpl) userContext.getManagerGroup()
				.getSecUserManager();
		SecUser secUser = secUserManager.getCachedSecUser(userContext);
	...
	*/
	public static SmartList<UserApp> getUserAppByName(InventoryUserContext userContext, SecUser secUser, String objectName) {
	...
	public static UserApp getUserAppByBindedEntity(InventoryUserContext userContext, BaseEntity userAppBindedObject) {
		MultipleAccessKey key = new MultipleAccessKey();
