...
public class FormActionManagerImpl extends CustomInventoryCheckerManager implements FormActionManager {
	...
	protected void throwExceptionWithMessage(String value) throws FormActionManagerException{
 	...
 	protected FormAction saveFormAction(InventoryUserContext userContext, FormAction formAction, String [] tokensExpr) throws Exception{	
 	...
 	protected FormAction saveFormActionDetail(InventoryUserContext userContext, FormAction formAction) throws Exception{	
 	...
 	public FormAction loadFormAction(InventoryUserContext userContext, String formActionId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public FormAction searchFormAction(InventoryUserContext userContext, String formActionId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected FormAction present(InventoryUserContext userContext, FormAction formAction, Map<String, Object> tokens) throws Exception {
 	...
 	public FormAction loadFormActionDetail(InventoryUserContext userContext, String formActionId) throws Exception{	
 		FormAction formAction = loadFormAction( userContext, formActionId, allTokens());
 		return present(userContext,formAction, allTokens());
		
 	}
 	
 	public Object view(InventoryUserContext userContext, String formActionId) throws Exception{	
 		FormAction formAction = loadFormAction( userContext, formActionId, viewTokens());
 		return present(userContext,formAction, allTokens());
		
 	}
 	protected FormAction saveFormAction(InventoryUserContext userContext, FormAction formAction, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getFormActionDAO().save(formAction, tokens);
 	}
 	protected FormAction loadFormAction(InventoryUserContext userContext, String formActionId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfFormAction(formActionId);
		userContext.getChecker().throwExceptionIfHasErrors( FormActionManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(InventoryUserContext userContext, FormAction formAction, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(InventoryUserContext userContext, FormAction formAction, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingFormAction(InventoryUserContext userContext,String formActionId, int formActionVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public FormAction clone(InventoryUserContext userContext, String fromFormActionId) throws Exception{
	...
	public FormAction internalSaveFormAction(InventoryUserContext userContext, FormAction formAction, Map<String,Object> options) throws Exception 
	{
	...
	public FormAction updateFormActionProperty(InventoryUserContext userContext,String formActionId, int formActionVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingFormAction(userContext, formActionId, formActionVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherForm(InventoryUserContext userContext, String formActionId, String anotherFormId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(InventoryUserContext userContext, String formActionId, int formActionVersion) throws Exception {
	...
	public FormAction forgetByAll(InventoryUserContext userContext, String formActionId, int formActionVersion) throws Exception {
		return forgetByAllInternal(userContext, formActionId, formActionVersion);		
	}
	protected FormAction forgetByAllInternal(InventoryUserContext userContext,
			String formActionId, int formActionVersion) throws Exception{
