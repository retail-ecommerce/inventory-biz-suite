...
public class BaseForm extends GenericForm{
	...
	protected FormField introductionFromProduct(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("Introduction");
		field.setLocaleKey("product.introduction");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("text");
	...
	protected FormField idFromSkuInventory(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("Id");
		field.setLocaleKey("sku_inventory.id");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("text");
	...
	protected FormField stockLevelFromSkuInventory(String parameterName, String initValue){
		...
		field.setLocaleKey("sku_inventory.stock_level");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("number");
		field.setRequired(true);
		field.setPlaceholder("请填写Stock Level");
		return field;
	}

	protected FormField backorderLevelFromSkuInventory(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("Backorder Level");
		field.setLocaleKey("sku_inventory.backorder_level");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("number");
		field.setRequired(true);
		field.setPlaceholder("请填写Backorder Level");
		return field;
	}

	protected FormField preorderLevelFromSkuInventory(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("Preorder Level");
		field.setLocaleKey("sku_inventory.preorder_level");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("number");
		field.setRequired(true);
		field.setPlaceholder("请填写Preorder Level");
		return field;
	}

	protected FormField stockThresholdFromSkuInventory(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("Stock Threshold");
		field.setLocaleKey("sku_inventory.stock_threshold");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("number");
		field.setRequired(true);
		field.setPlaceholder("请填写Stock Threshold");
		return field;
	}

	protected FormField backorderThresholFromSkuInventory(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("Backorder Threshol");
		field.setLocaleKey("sku_inventory.backorder_threshol");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("number");
		field.setRequired(true);
		field.setPlaceholder("请填写Backorder Threshol");
		return field;
	}

	protected FormField preorderThresholFromSkuInventory(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("Preorder Threshol");
		field.setLocaleKey("sku_inventory.preorder_threshol");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("number");
		field.setRequired(true);
		field.setPlaceholder("请填写Preorder Threshol");
		return field;
	}

	protected FormField statusFromSkuInventory(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("Status");
		field.setLocaleKey("sku_inventory.status");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("text");
	...
	protected FormField productIdFromSkuInventory(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("Product");
		field.setLocaleKey("sku_inventory.product");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
	...
	protected FormField platformIdFromSkuInventory(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("Platform");
		field.setLocaleKey("sku_inventory.platform");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("Platform");
