...
public class InventoryCheckerManager extends BaseManagerImpl {
	/*
	
	
	public static final String  ID_OF_PLATFORM ="platform.id";
	protected void checkIdOfPlatform(InventoryUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkNameOfPlatform(InventoryUserContext userContext, String name, List<Message> messageList)
	{
	...
	protected void checkIntroductionOfPlatform(InventoryUserContext userContext, String introduction, List<Message> messageList)
	{
	...
	protected void checkCurrentVersionOfPlatform(InventoryUserContext userContext, String currentVersion, List<Message> messageList)
	{
	...
	protected void checkVersionOfPlatform(InventoryUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfProduct(InventoryUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkNameOfProduct(InventoryUserContext userContext, String name, List<Message> messageList)
	{
		
	 	checkStringLengthRange(name,3, 44,NAME_OF_PRODUCT, messageList); 		
		
	}	 			
	
	public static final String  INTRODUCTION_OF_PRODUCT ="product.introduction";
	protected void checkIntroductionOfProduct(InventoryUserContext userContext, String introduction, List<Message> messageList)
	{
		
	 	checkStringLengthRange(introduction,10, 148,INTRODUCTION_OF_PRODUCT, messageList); 		
		
	}	 			
	
	public static final String  PLATFORM_OF_PRODUCT ="product.platform";
	protected void checkPlatformIdOfProduct(InventoryUserContext userContext, String platformId, List<Message> messageList)
	{
	...
	protected void checkVersionOfProduct(InventoryUserContext userContext, int version, List<Message> messageList)
	{
	...
	public static final String  ID_OF_SKU_INVENTORY ="sku_inventory.id";
	protected void checkIdOfSkuInventory(InventoryUserContext userContext, String id, List<Message> messageList)
	{
		
	 	checkStringLengthRange(id,5, 64,ID_OF_SKU_INVENTORY, messageList); 		
	...
	protected void checkStockLevelOfSkuInventory(InventoryUserContext userContext, int stockLevel, List<Message> messageList)
	{
	 	...
	 	checkIntegerRange(stockLevel,0, 1000,STOCK_LEVEL_OF_SKU_INVENTORY, messageList); 		
		
	}	 			
	
	public static final String  BACKORDER_LEVEL_OF_SKU_INVENTORY ="sku_inventory.backorder_level";
	protected void checkBackorderLevelOfSkuInventory(InventoryUserContext userContext, int backorderLevel, List<Message> messageList)
	{
		
	 	checkIntegerRange(backorderLevel,0, 1000,BACKORDER_LEVEL_OF_SKU_INVENTORY, messageList); 		
		
	}	 			
	
	public static final String  PREORDER_LEVEL_OF_SKU_INVENTORY ="sku_inventory.preorder_level";
	protected void checkPreorderLevelOfSkuInventory(InventoryUserContext userContext, int preorderLevel, List<Message> messageList)
	{
		
	 	checkIntegerRange(preorderLevel,0, 1000,PREORDER_LEVEL_OF_SKU_INVENTORY, messageList); 		
		
	}	 			
	
	public static final String  STOCK_THRESHOLD_OF_SKU_INVENTORY ="sku_inventory.stock_threshold";
	protected void checkStockThresholdOfSkuInventory(InventoryUserContext userContext, int stockThreshold, List<Message> messageList)
	{
		
	 	checkIntegerRange(stockThreshold,0, 1000,STOCK_THRESHOLD_OF_SKU_INVENTORY, messageList); 		
		
	}	 			
	
	public static final String  BACKORDER_THRESHOL_OF_SKU_INVENTORY ="sku_inventory.backorder_threshol";
	protected void checkBackorderThresholOfSkuInventory(InventoryUserContext userContext, int backorderThreshol, List<Message> messageList)
	{
		
	 	checkIntegerRange(backorderThreshol,0, 1000,BACKORDER_THRESHOL_OF_SKU_INVENTORY, messageList); 		
		
	}	 			
	
	public static final String  PREORDER_THRESHOL_OF_SKU_INVENTORY ="sku_inventory.preorder_threshol";
	protected void checkPreorderThresholOfSkuInventory(InventoryUserContext userContext, int preorderThreshol, List<Message> messageList)
	{
		
	 	checkIntegerRange(preorderThreshol,0, 1000,PREORDER_THRESHOL_OF_SKU_INVENTORY, messageList); 		
		
	}	 			
	
	public static final String  STATUS_OF_SKU_INVENTORY ="sku_inventory.status";
	protected void checkStatusOfSkuInventory(InventoryUserContext userContext, String status, List<Message> messageList)
	{
		
	 	checkStringLengthRange(status,4, 48,STATUS_OF_SKU_INVENTORY, messageList); 		
		
	}	 			
	
	public static final String  PRODUCT_OF_SKU_INVENTORY ="sku_inventory.product";
	protected void checkProductIdOfSkuInventory(InventoryUserContext userContext, String productId, List<Message> messageList)
	{
		
	 	checkIdOfSkuInventory(userContext,productId, messageList); 		
		
	}	 			
	
	public static final String  PLATFORM_OF_SKU_INVENTORY ="sku_inventory.platform";
	protected void checkPlatformIdOfSkuInventory(InventoryUserContext userContext, String platformId, List<Message> messageList)
	{
		
	 	checkIdOfSkuInventory(userContext,platformId, messageList); 		
		
	}	 			
	
	public static final String  VERSION_OF_SKU_INVENTORY ="sku_inventory.version";
	protected void checkVersionOfSkuInventory(InventoryUserContext userContext, int version, List<Message> messageList)
	{
		
	 	checkIntegerRange(version,0, Integer.MAX_VALUE,VERSION_OF_SKU_INVENTORY, messageList); 		
		
	}	 			
	
	public static final String  ID_OF_USER_DOMAIN ="user_domain.id";
	protected void checkIdOfUserDomain(InventoryUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkNameOfUserDomain(InventoryUserContext userContext, String name, List<Message> messageList)
	{
	...
	protected void checkVersionOfUserDomain(InventoryUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfUserWhiteList(InventoryUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkUserIdentityOfUserWhiteList(InventoryUserContext userContext, String userIdentity, List<Message> messageList)
	{
	...
	protected void checkUserSpecialFunctionsOfUserWhiteList(InventoryUserContext userContext, String userSpecialFunctions, List<Message> messageList)
	{
	...
	protected void checkDomainIdOfUserWhiteList(InventoryUserContext userContext, String domainId, List<Message> messageList)
	{
	...
	protected void checkVersionOfUserWhiteList(InventoryUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfSecUser(InventoryUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkLoginOfSecUser(InventoryUserContext userContext, String login, List<Message> messageList)
	{
	...
	protected void checkMobileOfSecUser(InventoryUserContext userContext, String mobile, List<Message> messageList)
	{
	...
	protected void checkEmailOfSecUser(InventoryUserContext userContext, String email, List<Message> messageList)
	{
	...
	protected void checkPwdOfSecUser(InventoryUserContext userContext, String pwd, List<Message> messageList)
	{
	...
	protected void checkVerificationCodeOfSecUser(InventoryUserContext userContext, int verificationCode, List<Message> messageList)
	{
	...
	protected void checkVerificationCodeExpireOfSecUser(InventoryUserContext userContext, DateTime verificationCodeExpire, List<Message> messageList)
	{
	...
	protected void checkLastLoginTimeOfSecUser(InventoryUserContext userContext, DateTime lastLoginTime, List<Message> messageList)
	{
	...
	protected void checkDomainIdOfSecUser(InventoryUserContext userContext, String domainId, List<Message> messageList)
	{
	...
	protected void checkVersionOfSecUser(InventoryUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfSecUserBlocking(InventoryUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkWhoOfSecUserBlocking(InventoryUserContext userContext, String who, List<Message> messageList)
	{
	...
	protected void checkCommentsOfSecUserBlocking(InventoryUserContext userContext, String comments, List<Message> messageList)
	{
	...
	protected void checkVersionOfSecUserBlocking(InventoryUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfUserApp(InventoryUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkTitleOfUserApp(InventoryUserContext userContext, String title, List<Message> messageList)
	{
	...
	protected void checkSecUserIdOfUserApp(InventoryUserContext userContext, String secUserId, List<Message> messageList)
	{
	...
	protected void checkAppIconOfUserApp(InventoryUserContext userContext, String appIcon, List<Message> messageList)
	{
	...
	protected void checkFullAccessOfUserApp(InventoryUserContext userContext, boolean fullAccess, List<Message> messageList)
	{
	...
	protected void checkPermissionOfUserApp(InventoryUserContext userContext, String permission, List<Message> messageList)
	{
	...
	protected void checkObjectTypeOfUserApp(InventoryUserContext userContext, String objectType, List<Message> messageList)
	{
	...
	protected void checkObjectIdOfUserApp(InventoryUserContext userContext, String objectId, List<Message> messageList)
	{
	...
	protected void checkLocationOfUserApp(InventoryUserContext userContext, String location, List<Message> messageList)
	{
	...
	protected void checkVersionOfUserApp(InventoryUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfListAccess(InventoryUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkNameOfListAccess(InventoryUserContext userContext, String name, List<Message> messageList)
	{
	...
	protected void checkInternalNameOfListAccess(InventoryUserContext userContext, String internalName, List<Message> messageList)
	{
	...
	protected void checkReadPermissionOfListAccess(InventoryUserContext userContext, boolean readPermission, List<Message> messageList)
	{
	...
	protected void checkCreatePermissionOfListAccess(InventoryUserContext userContext, boolean createPermission, List<Message> messageList)
	{
	...
	protected void checkDeletePermissionOfListAccess(InventoryUserContext userContext, boolean deletePermission, List<Message> messageList)
	{
	...
	protected void checkUpdatePermissionOfListAccess(InventoryUserContext userContext, boolean updatePermission, List<Message> messageList)
	{
	...
	protected void checkExecutionPermissionOfListAccess(InventoryUserContext userContext, boolean executionPermission, List<Message> messageList)
	{
	...
	protected void checkAppIdOfListAccess(InventoryUserContext userContext, String appId, List<Message> messageList)
	{
	...
	protected void checkVersionOfListAccess(InventoryUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfObjectAccess(InventoryUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkNameOfObjectAccess(InventoryUserContext userContext, String name, List<Message> messageList)
	{
	...
	protected void checkObjectTypeOfObjectAccess(InventoryUserContext userContext, String objectType, List<Message> messageList)
	{
	...
	protected void checkList1OfObjectAccess(InventoryUserContext userContext, String list1, List<Message> messageList)
	{
	...
	protected void checkList2OfObjectAccess(InventoryUserContext userContext, String list2, List<Message> messageList)
	{
	...
	protected void checkList3OfObjectAccess(InventoryUserContext userContext, String list3, List<Message> messageList)
	{
	...
	protected void checkList4OfObjectAccess(InventoryUserContext userContext, String list4, List<Message> messageList)
	{
	...
	protected void checkList5OfObjectAccess(InventoryUserContext userContext, String list5, List<Message> messageList)
	{
	...
	protected void checkList6OfObjectAccess(InventoryUserContext userContext, String list6, List<Message> messageList)
	{
	...
	protected void checkList7OfObjectAccess(InventoryUserContext userContext, String list7, List<Message> messageList)
	{
	...
	protected void checkList8OfObjectAccess(InventoryUserContext userContext, String list8, List<Message> messageList)
	{
	...
	protected void checkList9OfObjectAccess(InventoryUserContext userContext, String list9, List<Message> messageList)
	{
	...
	protected void checkAppIdOfObjectAccess(InventoryUserContext userContext, String appId, List<Message> messageList)
	{
	...
	protected void checkVersionOfObjectAccess(InventoryUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfLoginHistory(InventoryUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkFromIpOfLoginHistory(InventoryUserContext userContext, String fromIp, List<Message> messageList)
	{
	...
	protected void checkDescriptionOfLoginHistory(InventoryUserContext userContext, String description, List<Message> messageList)
	{
	...
	protected void checkSecUserIdOfLoginHistory(InventoryUserContext userContext, String secUserId, List<Message> messageList)
	{
	...
	protected void checkVersionOfLoginHistory(InventoryUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfGenericForm(InventoryUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkTitleOfGenericForm(InventoryUserContext userContext, String title, List<Message> messageList)
	{
	...
	protected void checkDescriptionOfGenericForm(InventoryUserContext userContext, String description, List<Message> messageList)
	{
	...
	protected void checkVersionOfGenericForm(InventoryUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfFormMessage(InventoryUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkTitleOfFormMessage(InventoryUserContext userContext, String title, List<Message> messageList)
	{
	...
	protected void checkFormIdOfFormMessage(InventoryUserContext userContext, String formId, List<Message> messageList)
	{
	...
	protected void checkLevelOfFormMessage(InventoryUserContext userContext, String level, List<Message> messageList)
	{
	...
	protected void checkVersionOfFormMessage(InventoryUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfFormFieldMessage(InventoryUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkTitleOfFormFieldMessage(InventoryUserContext userContext, String title, List<Message> messageList)
	{
	...
	protected void checkParameterNameOfFormFieldMessage(InventoryUserContext userContext, String parameterName, List<Message> messageList)
	{
	...
	protected void checkFormIdOfFormFieldMessage(InventoryUserContext userContext, String formId, List<Message> messageList)
	{
	...
	protected void checkLevelOfFormFieldMessage(InventoryUserContext userContext, String level, List<Message> messageList)
	{
	...
	protected void checkVersionOfFormFieldMessage(InventoryUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfFormField(InventoryUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkLabelOfFormField(InventoryUserContext userContext, String label, List<Message> messageList)
	{
	...
	protected void checkLocaleKeyOfFormField(InventoryUserContext userContext, String localeKey, List<Message> messageList)
	{
	...
	protected void checkParameterNameOfFormField(InventoryUserContext userContext, String parameterName, List<Message> messageList)
	{
	...
	protected void checkTypeOfFormField(InventoryUserContext userContext, String type, List<Message> messageList)
	{
	...
	protected void checkFormIdOfFormField(InventoryUserContext userContext, String formId, List<Message> messageList)
	{
	...
	protected void checkPlaceholderOfFormField(InventoryUserContext userContext, String placeholder, List<Message> messageList)
	{
	...
	protected void checkDefaultValueOfFormField(InventoryUserContext userContext, String defaultValue, List<Message> messageList)
	{
	...
	protected void checkDescriptionOfFormField(InventoryUserContext userContext, String description, List<Message> messageList)
	{
	...
	protected void checkFieldGroupOfFormField(InventoryUserContext userContext, String fieldGroup, List<Message> messageList)
	{
	...
	protected void checkMinimumValueOfFormField(InventoryUserContext userContext, String minimumValue, List<Message> messageList)
	{
	...
	protected void checkMaximumValueOfFormField(InventoryUserContext userContext, String maximumValue, List<Message> messageList)
	{
	...
	protected void checkRequiredOfFormField(InventoryUserContext userContext, boolean required, List<Message> messageList)
	{
	...
	protected void checkDisabledOfFormField(InventoryUserContext userContext, boolean disabled, List<Message> messageList)
	{
	...
	protected void checkCustomRenderingOfFormField(InventoryUserContext userContext, boolean customRendering, List<Message> messageList)
	{
	...
	protected void checkCandidateValuesOfFormField(InventoryUserContext userContext, String candidateValues, List<Message> messageList)
	{
	...
	protected void checkSuggestValuesOfFormField(InventoryUserContext userContext, String suggestValues, List<Message> messageList)
	{
	...
	protected void checkVersionOfFormField(InventoryUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfFormAction(InventoryUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkLabelOfFormAction(InventoryUserContext userContext, String label, List<Message> messageList)
	{
	...
	protected void checkLocaleKeyOfFormAction(InventoryUserContext userContext, String localeKey, List<Message> messageList)
	{
	...
	protected void checkActionKeyOfFormAction(InventoryUserContext userContext, String actionKey, List<Message> messageList)
	{
	...
	protected void checkLevelOfFormAction(InventoryUserContext userContext, String level, List<Message> messageList)
	{
	...
	protected void checkUrlOfFormAction(InventoryUserContext userContext, String url, List<Message> messageList)
	{
	...
	protected void checkFormIdOfFormAction(InventoryUserContext userContext, String formId, List<Message> messageList)
	{
	...
	protected void checkVersionOfFormAction(InventoryUserContext userContext, int version, List<Message> messageList)
	{
		...
		if (!(baseUserContext instanceof InventoryUserContext)){
			super.checkAccess(baseUserContext, methodName, parameters);
			return accessOK();
		}
		InventoryUserContext userContext = (InventoryUserContext) baseUserContext;
	...
	protected void throwExceptionIfHasErrors(InventoryUserContext userContext, List<Message> messageList, Class<? extends InventoryException> exceptionClazz) throws Exception{
		//translate messages;
	...
	*/
	...
	protected void checkDateNow(Date likeTime, int i, Object now,
			String targetFieldName, InventoryException exception) {
