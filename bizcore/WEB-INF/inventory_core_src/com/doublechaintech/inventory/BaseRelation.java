...
public class BaseRelation{
	...
	protected void prepareRelationIndex()
	{
		...
		addRelationIndex("SkuInventory",skuInventoryRelatedObjectNames);
	...
	protected void prepareRelation()
	{
		...
		addGenericRelation("SkuInventory"                          ,TRUST_CHAIN_READ,"product");
		addGenericRelation("SkuInventory"                          ,TRUST_CHAIN_READ,"platform");
		addGenericRelation(<html>
<body>
