...
import com.doublechaintech.inventory.userapp.UserAppDAO;
import com.doublechaintech.inventory.userdomain.UserDomainDAO;
import com.doublechaintech.inventory.secuserblocking.SecUserBlockingDAO;
import com.doublechaintech.inventory.loginhistory.LoginHistoryDAO;



import org.springframework.dao.EmptyResultDataAccessException;

public class SecUserJDBCTemplateDAO extends InventoryNamingServiceDAO implements SecUserDAO{
	...
	*/
    ...
    public SmartList<SecUser> requestCandidateSecUserForUserApp(InventoryUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
    ...
    public SmartList<SecUser> requestCandidateSecUserForLoginHistory(InventoryUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
        // NOTE: by default, ignore owner info, just return all by filter key.
		// You need override this method if you have different candidate-logic
		return findAllCandidateByFilter(SecUserTable.COLUMN_LOGIN, filterKey, pageNo, pageSize, getSecUserMapper());
    }
