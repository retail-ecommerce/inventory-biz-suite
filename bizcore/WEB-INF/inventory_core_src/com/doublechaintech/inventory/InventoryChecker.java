...
public class InventoryChecker extends BaseChecker{
	
	
	protected InventoryUserContext userContext;
	public InventoryUserContext getUserContext() {
		return userContext;
	}
	public void setUserContext(InventoryUserContext userContext) {
	...
	public InventoryChecker checkIdOfPlatform(String id)
	{
	...
	public InventoryChecker checkNameOfPlatform(String name)
	{
	...
	public InventoryChecker checkIntroductionOfPlatform(String introduction)
	{
	...
	public InventoryChecker checkCurrentVersionOfPlatform(String currentVersion)
	{
	...
	public InventoryChecker checkVersionOfPlatform(int version)
	{
	...
	public InventoryChecker checkIdOfProduct(String id)
	{
	...
	public InventoryChecker checkNameOfProduct(String name)
	{
		
	 	checkStringLengthRange(name,3, 44,NAME_OF_PRODUCT ); 		
		
		return this;
	}	 			

	public static final String  INTRODUCTION_OF_PRODUCT ="product.introduction";
	public InventoryChecker checkIntroductionOfProduct(String introduction)
	{
		
	 	checkStringLengthRange(introduction,10, 148,INTRODUCTION_OF_PRODUCT ); 		
		
		return this;
	}	 			

	public static final String  PLATFORM_OF_PRODUCT ="product.platform";
	public InventoryChecker checkPlatformIdOfProduct(String platformId)
	{
	...
	public InventoryChecker checkVersionOfProduct(int version)
	{
	...
	public InventoryChecker checkIdOfSkuInventory(String id)
	{
		
	 	checkStringLengthRange(id,5, 64,ID_OF_SKU_INVENTORY ); 		
	...
	public InventoryChecker checkStockLevelOfSkuInventory(int stockLevel)
	{
	 	...
	 	checkIntegerRange(stockLevel,0, 1000,STOCK_LEVEL_OF_SKU_INVENTORY ); 		
		
		return this;
	}	 			

	public static final String  BACKORDER_LEVEL_OF_SKU_INVENTORY ="sku_inventory.backorder_level";
	public InventoryChecker checkBackorderLevelOfSkuInventory(int backorderLevel)
	{
		
	 	checkIntegerRange(backorderLevel,0, 1000,BACKORDER_LEVEL_OF_SKU_INVENTORY ); 		
		
		return this;
	}	 			

	public static final String  PREORDER_LEVEL_OF_SKU_INVENTORY ="sku_inventory.preorder_level";
	public InventoryChecker checkPreorderLevelOfSkuInventory(int preorderLevel)
	{
		
	 	checkIntegerRange(preorderLevel,0, 1000,PREORDER_LEVEL_OF_SKU_INVENTORY ); 		
		
		return this;
	}	 			

	public static final String  STOCK_THRESHOLD_OF_SKU_INVENTORY ="sku_inventory.stock_threshold";
	public InventoryChecker checkStockThresholdOfSkuInventory(int stockThreshold)
	{
		
	 	checkIntegerRange(stockThreshold,0, 1000,STOCK_THRESHOLD_OF_SKU_INVENTORY ); 		
		
		return this;
	}	 			

	public static final String  BACKORDER_THRESHOL_OF_SKU_INVENTORY ="sku_inventory.backorder_threshol";
	public InventoryChecker checkBackorderThresholOfSkuInventory(int backorderThreshol)
	{
		
	 	checkIntegerRange(backorderThreshol,0, 1000,BACKORDER_THRESHOL_OF_SKU_INVENTORY ); 		
		
		return this;
	}	 			

	public static final String  PREORDER_THRESHOL_OF_SKU_INVENTORY ="sku_inventory.preorder_threshol";
	public InventoryChecker checkPreorderThresholOfSkuInventory(int preorderThreshol)
	{
		
	 	checkIntegerRange(preorderThreshol,0, 1000,PREORDER_THRESHOL_OF_SKU_INVENTORY ); 		
		
		return this;
	}	 			

	public static final String  STATUS_OF_SKU_INVENTORY ="sku_inventory.status";
	public InventoryChecker checkStatusOfSkuInventory(String status)
	{
		
	 	checkStringLengthRange(status,4, 48,STATUS_OF_SKU_INVENTORY ); 		
		
		return this;
	}	 			

	public static final String  PRODUCT_OF_SKU_INVENTORY ="sku_inventory.product";
	public InventoryChecker checkProductIdOfSkuInventory(String productId)
	{
		
	 	checkIdOfSkuInventory(productId ); 		
		
		return this;
	}	 			

	public static final String  PLATFORM_OF_SKU_INVENTORY ="sku_inventory.platform";
	public InventoryChecker checkPlatformIdOfSkuInventory(String platformId)
	{
		
	 	checkIdOfSkuInventory(platformId ); 		
		
		return this;
	}	 			

	public static final String  VERSION_OF_SKU_INVENTORY ="sku_inventory.version";
	public InventoryChecker checkVersionOfSkuInventory(int version)
	{
		
	 	checkIntegerRange(version,0, Integer.MAX_VALUE,VERSION_OF_SKU_INVENTORY ); 		
		
		return this;
	}	 			

	public static final String  ID_OF_USER_DOMAIN ="user_domain.id";
	public InventoryChecker checkIdOfUserDomain(String id)
	{
	...
	public InventoryChecker checkNameOfUserDomain(String name)
	{
	...
	public InventoryChecker checkVersionOfUserDomain(int version)
	{
	...
	public InventoryChecker checkIdOfUserWhiteList(String id)
	{
	...
	public InventoryChecker checkUserIdentityOfUserWhiteList(String userIdentity)
	{
	...
	public InventoryChecker checkUserSpecialFunctionsOfUserWhiteList(String userSpecialFunctions)
	{
	...
	public InventoryChecker checkDomainIdOfUserWhiteList(String domainId)
	{
	...
	public InventoryChecker checkVersionOfUserWhiteList(int version)
	{
	...
	public InventoryChecker checkIdOfSecUser(String id)
	{
	...
	public InventoryChecker checkLoginOfSecUser(String login)
	{
	...
	public InventoryChecker checkMobileOfSecUser(String mobile)
	{
	...
	public InventoryChecker checkEmailOfSecUser(String email)
	{
	...
	public InventoryChecker checkPwdOfSecUser(String pwd)
	{
	...
	public InventoryChecker checkVerificationCodeOfSecUser(int verificationCode)
	{
	...
	public InventoryChecker checkVerificationCodeExpireOfSecUser(DateTime verificationCodeExpire)
	{
	...
	public InventoryChecker checkLastLoginTimeOfSecUser(DateTime lastLoginTime)
	{
	...
	public InventoryChecker checkDomainIdOfSecUser(String domainId)
	{
	...
	public InventoryChecker checkVersionOfSecUser(int version)
	{
	...
	public InventoryChecker checkIdOfSecUserBlocking(String id)
	{
	...
	public InventoryChecker checkWhoOfSecUserBlocking(String who)
	{
	...
	public InventoryChecker checkCommentsOfSecUserBlocking(String comments)
	{
	...
	public InventoryChecker checkVersionOfSecUserBlocking(int version)
	{
	...
	public InventoryChecker checkIdOfUserApp(String id)
	{
	...
	public InventoryChecker checkTitleOfUserApp(String title)
	{
	...
	public InventoryChecker checkSecUserIdOfUserApp(String secUserId)
	{
	...
	public InventoryChecker checkAppIconOfUserApp(String appIcon)
	{
	...
	public InventoryChecker checkFullAccessOfUserApp(boolean fullAccess)
	{
	...
	public InventoryChecker checkPermissionOfUserApp(String permission)
	{
	...
	public InventoryChecker checkObjectTypeOfUserApp(String objectType)
	{
	...
	public InventoryChecker checkObjectIdOfUserApp(String objectId)
	{
	...
	public InventoryChecker checkLocationOfUserApp(String location)
	{
	...
	public InventoryChecker checkVersionOfUserApp(int version)
	{
	...
	public InventoryChecker checkIdOfListAccess(String id)
	{
	...
	public InventoryChecker checkNameOfListAccess(String name)
	{
	...
	public InventoryChecker checkInternalNameOfListAccess(String internalName)
	{
	...
	public InventoryChecker checkReadPermissionOfListAccess(boolean readPermission)
	{
	...
	public InventoryChecker checkCreatePermissionOfListAccess(boolean createPermission)
	{
	...
	public InventoryChecker checkDeletePermissionOfListAccess(boolean deletePermission)
	{
	...
	public InventoryChecker checkUpdatePermissionOfListAccess(boolean updatePermission)
	{
	...
	public InventoryChecker checkExecutionPermissionOfListAccess(boolean executionPermission)
	{
	...
	public InventoryChecker checkAppIdOfListAccess(String appId)
	{
	...
	public InventoryChecker checkVersionOfListAccess(int version)
	{
	...
	public InventoryChecker checkIdOfObjectAccess(String id)
	{
	...
	public InventoryChecker checkNameOfObjectAccess(String name)
	{
	...
	public InventoryChecker checkObjectTypeOfObjectAccess(String objectType)
	{
	...
	public InventoryChecker checkList1OfObjectAccess(String list1)
	{
	...
	public InventoryChecker checkList2OfObjectAccess(String list2)
	{
	...
	public InventoryChecker checkList3OfObjectAccess(String list3)
	{
	...
	public InventoryChecker checkList4OfObjectAccess(String list4)
	{
	...
	public InventoryChecker checkList5OfObjectAccess(String list5)
	{
	...
	public InventoryChecker checkList6OfObjectAccess(String list6)
	{
	...
	public InventoryChecker checkList7OfObjectAccess(String list7)
	{
	...
	public InventoryChecker checkList8OfObjectAccess(String list8)
	{
	...
	public InventoryChecker checkList9OfObjectAccess(String list9)
	{
	...
	public InventoryChecker checkAppIdOfObjectAccess(String appId)
	{
	...
	public InventoryChecker checkVersionOfObjectAccess(int version)
	{
	...
	public InventoryChecker checkIdOfLoginHistory(String id)
	{
	...
	public InventoryChecker checkFromIpOfLoginHistory(String fromIp)
	{
	...
	public InventoryChecker checkDescriptionOfLoginHistory(String description)
	{
	...
	public InventoryChecker checkSecUserIdOfLoginHistory(String secUserId)
	{
	...
	public InventoryChecker checkVersionOfLoginHistory(int version)
	{
	...
	public InventoryChecker checkIdOfGenericForm(String id)
	{
	...
	public InventoryChecker checkTitleOfGenericForm(String title)
	{
	...
	public InventoryChecker checkDescriptionOfGenericForm(String description)
	{
	...
	public InventoryChecker checkVersionOfGenericForm(int version)
	{
	...
	public InventoryChecker checkIdOfFormMessage(String id)
	{
	...
	public InventoryChecker checkTitleOfFormMessage(String title)
	{
	...
	public InventoryChecker checkFormIdOfFormMessage(String formId)
	{
	...
	public InventoryChecker checkLevelOfFormMessage(String level)
	{
	...
	public InventoryChecker checkVersionOfFormMessage(int version)
	{
	...
	public InventoryChecker checkIdOfFormFieldMessage(String id)
	{
	...
	public InventoryChecker checkTitleOfFormFieldMessage(String title)
	{
	...
	public InventoryChecker checkParameterNameOfFormFieldMessage(String parameterName)
	{
	...
	public InventoryChecker checkFormIdOfFormFieldMessage(String formId)
	{
	...
	public InventoryChecker checkLevelOfFormFieldMessage(String level)
	{
	...
	public InventoryChecker checkVersionOfFormFieldMessage(int version)
	{
	...
	public InventoryChecker checkIdOfFormField(String id)
	{
	...
	public InventoryChecker checkLabelOfFormField(String label)
	{
	...
	public InventoryChecker checkLocaleKeyOfFormField(String localeKey)
	{
	...
	public InventoryChecker checkParameterNameOfFormField(String parameterName)
	{
	...
	public InventoryChecker checkTypeOfFormField(String type)
	{
	...
	public InventoryChecker checkFormIdOfFormField(String formId)
	{
	...
	public InventoryChecker checkPlaceholderOfFormField(String placeholder)
	{
	...
	public InventoryChecker checkDefaultValueOfFormField(String defaultValue)
	{
	...
	public InventoryChecker checkDescriptionOfFormField(String description)
	{
	...
	public InventoryChecker checkFieldGroupOfFormField(String fieldGroup)
	{
	...
	public InventoryChecker checkMinimumValueOfFormField(String minimumValue)
	{
	...
	public InventoryChecker checkMaximumValueOfFormField(String maximumValue)
	{
	...
	public InventoryChecker checkRequiredOfFormField(boolean required)
	{
	...
	public InventoryChecker checkDisabledOfFormField(boolean disabled)
	{
	...
	public InventoryChecker checkCustomRenderingOfFormField(boolean customRendering)
	{
	...
	public InventoryChecker checkCandidateValuesOfFormField(String candidateValues)
	{
	...
	public InventoryChecker checkSuggestValuesOfFormField(String suggestValues)
	{
	...
	public InventoryChecker checkVersionOfFormField(int version)
	{
	...
	public InventoryChecker checkIdOfFormAction(String id)
	{
	...
	public InventoryChecker checkLabelOfFormAction(String label)
	{
	...
	public InventoryChecker checkLocaleKeyOfFormAction(String localeKey)
	{
	...
	public InventoryChecker checkActionKeyOfFormAction(String actionKey)
	{
	...
	public InventoryChecker checkLevelOfFormAction(String level)
	{
	...
	public InventoryChecker checkUrlOfFormAction(String url)
	{
	...
	public InventoryChecker checkFormIdOfFormAction(String formId)
	{
	...
	public InventoryChecker checkVersionOfFormAction(int version)
	{
