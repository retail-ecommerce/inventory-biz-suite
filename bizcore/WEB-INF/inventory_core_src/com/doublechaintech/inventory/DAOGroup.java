...
import com.doublechaintech.inventory.platform.PlatformTokens;
import com.doublechaintech.inventory.product.Product;
import com.doublechaintech.inventory.product.ProductDAO;
import com.doublechaintech.inventory.product.ProductTokens;
...
import com.doublechaintech.inventory.skuinventory.SkuInventoryTokens;
import com.doublechaintech.inventory.userdomain.UserDomain;
import com.doublechaintech.inventory.userdomain.UserDomainDAO;
import com.doublechaintech.inventory.userdomain.UserDomainTokens;
...
import com.doublechaintech.inventory.userwhitelist.UserWhiteListTokens;
import com.doublechaintech.inventory.secuser.SecUser;
import com.doublechaintech.inventory.secuser.SecUserDAO;
import com.doublechaintech.inventory.secuser.SecUserTokens;
...
import com.doublechaintech.inventory.secuserblocking.SecUserBlockingTokens;
...
import com.doublechaintech.inventory.listaccess.ListAccessTokens;
...
import com.doublechaintech.inventory.objectaccess.ObjectAccessTokens;
...
import com.doublechaintech.inventory.loginhistory.LoginHistoryTokens;
...
import com.doublechaintech.inventory.genericform.GenericFormTokens;
...
import com.doublechaintech.inventory.formmessage.FormMessageTokens;
...
public class DAOGroup {
	...
	public void setSkuInventoryDAO(SkuInventoryDAO dao){
		this.skuInventoryDAO = dao;
	}
	...
	static {
		...
		internalLoaderMap.put("SkuInventory", new BasicLoader() {
			@Override
			public BaseEntity loadBasicData(DAOGroup daoGoup, String id) throws Exception {
				return daoGoup.getSkuInventoryDAO().load(id, SkuInventoryTokens.withoutLists());
			}
			@Override
			public BaseEntity loadBasicDataWithToken(DAOGroup daoGoup, String id, Map<String, Object> tokens) throws Exception {
				return daoGoup.getSkuInventoryDAO().load(id, tokens);
			}
			@Override
			public BaseEntity present(DAOGroup daoGoup, BaseEntity data, Map<String, Object> tokens) throws Exception {
				return daoGoup.getSkuInventoryDAO().present((SkuInventory)data, tokens);
			}
		});
