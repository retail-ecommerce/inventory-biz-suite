...
import com.doublechaintech.inventory.formmessage.FormMessageDAO;
import com.doublechaintech.inventory.formfieldmessage.FormFieldMessageDAO;
import com.doublechaintech.inventory.formfield.FormFieldDAO;
import com.doublechaintech.inventory.formaction.FormActionDAO;



import org.springframework.dao.EmptyResultDataAccessException;

public class GenericFormJDBCTemplateDAO extends InventoryNamingServiceDAO implements GenericFormDAO{
	...
	*/
    ...
    public SmartList<GenericForm> requestCandidateGenericFormForFormMessage(InventoryUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
    ...
    public SmartList<GenericForm> requestCandidateGenericFormForFormFieldMessage(InventoryUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
        // NOTE: by default, ignore owner info, just return all by filter key.
		// You need override this method if you have different candidate-logic
		return findAllCandidateByFilter(GenericFormTable.COLUMN_TITLE, filterKey, pageNo, pageSize, getGenericFormMapper());
    }
		
    public SmartList<GenericForm> requestCandidateGenericFormForFormField(InventoryUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
        // NOTE: by default, ignore owner info, just return all by filter key.
		// You need override this method if you have different candidate-logic
		return findAllCandidateByFilter(GenericFormTable.COLUMN_TITLE, filterKey, pageNo, pageSize, getGenericFormMapper());
    }
		
    public SmartList<GenericForm> requestCandidateGenericFormForFormAction(InventoryUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
        // NOTE: by default, ignore owner info, just return all by filter key.
		// You need override this method if you have different candidate-logic
		return findAllCandidateByFilter(GenericFormTable.COLUMN_TITLE, filterKey, pageNo, pageSize, getGenericFormMapper());
    }
