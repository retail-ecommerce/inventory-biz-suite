...
public class InventoryExceptionJsonSerializer extends  JsonSerializer<InventoryException> {
	...
	@Override
	public void serialize(InventoryException exception, JsonGenerator jgen,
	...
	protected void writeExceptionMessage(String message, InventoryException exception,
	...
	protected void writeStartObject(InventoryException exception, JsonGenerator jgen,SerializerProvider provider)throws IOException,JsonProcessingException{
		jgen.writeStartObject();
		writeClassField(CLASS,exception,jgen,provider);
	}
	
	private static final String MESSAGE_LIST = "messageList";
	protected void writeEndObject(InventoryException exception, JsonGenerator jgen,SerializerProvider provider)throws IOException,JsonProcessingException{
		
		writeMessageList(MESSAGE_LIST,exception,jgen,provider);
		jgen.writeEndObject();
	}
	protected void writeClassField(String fieldName,InventoryException exception,
	...
	protected void writeMessageList(String fieldName,InventoryException exception,
			JsonGenerator jgen, SerializerProvider provider)
			throws IOException, JsonProcessingException {
		if(exception == null){
			return; //do nothing when base entity is null
