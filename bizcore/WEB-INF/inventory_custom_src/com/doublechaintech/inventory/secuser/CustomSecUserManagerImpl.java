...
import com.doublechaintech.inventory.InventoryUserContextImpl;
import com.doublechaintech.inventory.LoginForm;
import com.doublechaintech.inventory.BaseEntity;
import com.doublechaintech.inventory.CommonError;
import com.doublechaintech.inventory.DAOGroup;
import com.doublechaintech.inventory.ManagerGroup;

import com.doublechaintech.inventory.UserContextImpl;
import com.doublechaintech.inventory.userapp.UserApp;
import com.doublechaintech.inventory.InventoryUserContext;
import com.doublechaintech.inventory.userapp.*;
import com.doublechaintech.inventory.listaccess.*;
import com.doublechaintech.inventory.objectaccess.*;
import com.doublechaintech.inventory.InventoryChecker;
...
public class CustomSecUserManagerImpl extends SecUserManagerImpl implements
    ...
    public String confirmSession(InventoryUserContext userContext){
    ...
    public Object resetPassword(InventoryUserContext userContext, String mobile, int verifycationCode, String newPassword) {
    ...
    public Object resetPasswordWithoutLogin(InventoryUserContext userContext, String loginType, String loginKey, int verifycationCode, String newPassword) {
        SecUser user;
        try {
    ...
    public Object selectApp(InventoryUserContext userContext,
    ...
    public SecUser manage(InventoryUserContext userContext) throws Exception{
        SecUser user = cachedUser(userContext);
    ...
    protected SecUser cachedUser(InventoryUserContext userContext)
    {
        return (SecUser)userContext.getCachedObject(this.getUserKey(userContext), SecUser.class);
    }
    
    public SecUser getCachedSecUser(InventoryUserContext userContext) {
    ...
    protected Object gotoApp(InventoryUserContext userContext, UserApp app) throws Exception {
    ...
    public String getVerificationCode(InventoryUserContext userContext,String mobile){
    ...
    protected void sendVerificationCode(InventoryUserContext userContext, String mobile,String code) throws Exception{
    ...
    protected int getRandomVerificationCode(InventoryUserContext userContex, int length){
    ...
    protected String getBeanName(InventoryUserContext userContext, UserApp app){
    ...
    protected String getTargetObjectId(InventoryUserContext userContext, UserApp app){
        
        return  app.getObjectId();
        
    }
    protected String getServiceType(InventoryUserContext userContext, UserApp app){
        
        return app.getObjectType();
    }
    protected String getMethodName(InventoryUserContext userContext, UserApp app){
    ...
    public Object home(InventoryUserContext userContext) {
    ...
    public Object loginWithEmail(InventoryUserContext userContext, String email,
            String password) {

        return loginInternal(userContext,"email",email, password);
    
    }
    public Object login(InventoryUserContext userContext, String email,
            String password) {
    ...
    public Object loginWithLogin(InventoryUserContext userContext, String email,
            String password) {

        return loginInternal(userContext,"login",email, password);
    
    }
    public Object loginWithMobile(InventoryUserContext userContext, String email,
            String password) {
        return loginInternal(userContext,"mobile",email, password);
    
    }
    protected SecUser loadUserWith(InventoryUserContext userContext, String type, String userId) throws Exception{
    ...
    protected Object loginInternal(InventoryUserContext userContext, String type, String userId,
            String password) {
     ...
     */
    protected Object loginTheSecUserInternal(InventoryUserContext userContext, SecUser user, String loginComments) throws Exception {
    ...
    public Object showlogin(InventoryUserContext userContext) {
    ...
    protected LoginForm showSessionExpired(InventoryUserContext userContext) {
    ...
    public BaseUserContext loadUserConext(HttpServletRequest request)
        ...
        InventoryUserContextImpl uc = createNewConext(path);
        init(uc, request);
        return uc;
    }
    ...
    public InventoryChecker getChecker(){
        return checker;
    }
    
    public void setChecker(InventoryChecker checker){
    ...
    protected void init(UserContextImpl userContext, HttpServletRequest request) {
        ...
        userContext.setChecker((InventoryChecker)beanFactory.getBean(getCheckerBeanName()));
    ...
    protected InventoryUserContextImpl createNewConext(String path) {

        return new InventoryUserContextImpl();
    ...
    public Object checkOtherLogin(InventoryUserContext userContext) throws Exception {
	...
	protected void checkUserHasManagementAccess(InventoryUserContext userContext, String objectType, String objectId)
	...
	public UserApp updateAppPermission(InventoryUserContext userContext, String secUserId, String userAppId, int version,
	...
	public UserApp updateListAccess(InventoryUserContext userContext, String secUserId, String userAppId, String displayName,
	...
	public UserApp loadUserAppWithUser(InventoryUserContext userContext, String secUserId, String objectType,
    ...
    public Object changeCurUserPassword(InventoryUserContext userContext, String currentPassword, String newPassword)
			throws Exception {
	...
	public String testIfHasManagementAccess(InventoryUserContext userContext,String objectType,String objectId) {
		try {
			this.checkUserHasManagementAccess(userContext, objectType, objectId);
			return "OK";
		}catch(Exception e){
