...
import styles from './SkuInventory.search.less'
...
class SkuInventorySearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      skuInventoryList: 1,
      'skuInventoryList.searchField': fieldName,
      'skuInventoryList.searchVerb': 'startsWith',
      'skuInventoryList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`skuInventoryList.searchField`] = fieldName
    value[`skuInventoryList.searchVerb`] =  searchVerb
    value[`skuInventoryList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['skuInventoryList'] = 1
      params['skuInventoryList.orderBy.0'] = "id"
      params['skuInventoryList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        skuInventorySearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(SkuInventorySearchForm)
