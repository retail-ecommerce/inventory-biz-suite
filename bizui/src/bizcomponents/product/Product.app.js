...
class ProductBizApp extends React.PureComponent {
  ...
  getSkuInventoryCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._product.skuInventorySearchFormParameters,
      loading: state._product.loading,
      owner: { type: '_product', id: state._product.id, referenceName: 'product', listName: 'skuInventoryList', ref:state._product, listDisplayName: appLocaleName(userContext,"List")}, // this is for model namespace and
  ...
  getSkuInventoryUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_product', id: state._product.id, listName: 'skuInventoryList', ref:state._product, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
