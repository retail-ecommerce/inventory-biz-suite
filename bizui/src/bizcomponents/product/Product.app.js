...
class ProductBizApp extends React.PureComponent {
  ...
  getSkuInventorySearch = () => {
    ...
    return connect(state => ({
      ...
      name: "Sku Inventory",
      role: "skuInventory",
      data: state._product.skuInventoryList,
      metaInfo: state._product.skuInventoryListMetaInfo,
      count: state._product.skuInventoryCount,
      currentPage: state._product.skuInventoryCurrentPageNumber,
      searchFormParameters: state._product.skuInventorySearchFormParameters,
      ...
      listName: 'skuInventoryList', ref:state._product, 
      listDisplayName: 'Sku Inventory列表' }, // this is for model namespace and
    }))(SkuInventorySearch)
  }
  getSkuInventoryCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._product.skuInventorySearchFormParameters,
      loading: state._product.loading,
      owner: { type: '_product', id: state._product.id, referenceName: 'product', listName: 'skuInventoryList', ref:state._product, listDisplayName: 'Sku Inventory列表'}, // this is for model namespace and
  ...
  getSkuInventoryUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_product', id: state._product.id, listName: 'skuInventoryList', ref:state._product, listDisplayName: 'Sku Inventory列表' }, // this is for model namespace and
  ...
  buildRouters = () =>{
  	...
  	{path:"/product/:id/list/skuInventoryList", component: this.getSkuInventorySearch()},
  	{path:"/product/:id/list/skuInventoryCreateForm", component: this.getSkuInventoryCreateForm()},
  	{path:"/product/:id/list/skuInventoryUpdateForm", component: this.getSkuInventoryUpdateForm()},
