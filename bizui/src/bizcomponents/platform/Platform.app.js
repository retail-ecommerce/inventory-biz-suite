...
class PlatformBizApp extends React.PureComponent {
  ...
  getSkuInventoryCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._platform.skuInventorySearchFormParameters,
      loading: state._platform.loading,
      owner: { type: '_platform', id: state._platform.id, referenceName: 'platform', listName: 'skuInventoryList', ref:state._platform, listDisplayName: 'Sku Inventory列表'}, // this is for model namespace and
  ...
  getSkuInventoryUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      role: "skuInventory",
      currentUpdateIndex: state._platform.currentUpdateIndex,
      owner: { type: '_platform', id: state._platform.id, listName: 'skuInventoryList', ref:state._platform, listDisplayName: 'Sku Inventory列表' }, // this is for model namespace and
